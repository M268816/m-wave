...
> In Citrix, check with your IT department about macro permissions
...
OLD WORKFLOW:
1. Select data in Citrix Excel
2. Copy to clipboard
3. Paste into local Notepad (to avoid truncation)
4. Copy from Notepad
5. Paste into local Excel
6. Data may still be in wrong format

NEW WORKFLOW:
1. Run macro in Citrix Excel (ALT + F8, select macro, Run)
2. Paste into local Excel or Notepad
3. Done! All data preserved correctly
...
Need help? Contact your IT support team or the person who provided this macro.
