...
class TagGenFileType(str, Enum):
    NONE = "Select a file type"
    KEPWARE_TAGS = "Kepware Tags"
    PI_TAGS = "PI Tags (Doc# 20701076)"


TAG_GEN_FILE_OPTIONS: dict[TagGenFileType, list[TagGeneratorType]] = {
    TagGenFileType.NONE: [
        TagGeneratorType.NONE,
    ],
    TagGenFileType.KEPWARE_TAGS: [
        TagGeneratorType.NONE,
        TagGeneratorType.ALL,
        TagGeneratorType.KEPWARE_TAG_TO_ATTRIBUTE,
        TagGeneratorType.KEPWARE_TO_FILTER,
        TagGeneratorType.INSTRUMENT_TAGS,
        TagGeneratorType.KEPWARE_TO_PI_TAGS,
    ],
    TagGenFileType.PI_TAGS: [
        TagGeneratorType.NONE,
        TagGeneratorType.ALL,
        TagGeneratorType.PI_TAGS_TO_KEPWARE_TAGS,
    ],
}
