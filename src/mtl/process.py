...
class Process:
    ...
    def compare_input(self) -> bool:
        ...
        try:
            ...
            self.report.subtitle(
                f"THIS REPORT WAS GENERATED BY: {self.report.user} ON {self.report.timestamp_merck}"
            )
            self.report.subtitle("USERNAME CAPTURED AUTOMATICALLY AT THE SYSTEM LEVEL")
    ...
    def append_input(self) -> bool:
        ...
        try:
            ...
            self.report.subtitle(f"THIS REPORT WAS GENERATED BY: {self.report.user}")
            self.report.subtitle("USERNAME CAPTURED AUTOMATICALLY AT THE SYSTEM LEVEL")
